...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__divide

#else
#  define SWIG_init    init_divide

#endif
#define SWIG_name    "_divide"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_divideC(PyObject *self, PyObject *args) {
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "divideC", 2, 2, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "divideC" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  ecode2 = SWIG_AsVal_int(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "divideC" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  result = (double)divideC(arg1,arg2);
...
static PyMethodDef SwigMethods[] = {
	 { "divideC", _wrap_divideC, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
